    ...
    <div>
        <div className="row">
            ...
            <div className="col-md-2">
                <div className="header-item2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus odio iure quod, maiores nobis reiciendis ad quibusdam, commodi v.</div>
            </div>
